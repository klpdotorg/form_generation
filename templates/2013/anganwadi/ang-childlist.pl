...
sub format_children_pdf {
    ...
    my $tt = Template->new({
        # DEBUG => 'all',
        INCLUDE_PATH => '',
        OUTPUT_PATH => 'angchildren/missings',
