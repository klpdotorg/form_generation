...
\usepackage[a3paper,top=2cm,left=0.5cm,right=1cm,bottom=2cm,landscape]{geometry}
\usepackage{makecell}
...
\rhead{\textbf{RCT Akshara Math-- PreTest-- 2012-2013} \\ \LARGE{\textbf{Class: 2}}\\ \small{\textbf{Field Investigator:}} \rule{5cm}{0.3pt}}
\lfoot{\small{Form ID: }}
