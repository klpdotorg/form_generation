...
\usepackage[legalpaper,top=2cm,left=0.5cm,right=1cm,bottom=2cm,landscape]{geometry}
\usepackage{makecell}
...
\rhead{\textbf{RCT-English Research \& Evaluation- June 2012} \\ \LARGE{\textbf{Class: 4}}\\ \small{\textbf{Field Investigator:}} \rule{5cm}{0.3pt}}
\lfoot{\small{Form ID: }}
